...
<?php echo form_open(site_url('teacher/manage_online_exam_question/'.$online_exam_id.'/add/fill_in_the_blanks') , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>
