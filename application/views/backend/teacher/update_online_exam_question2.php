    ...
    <div class="col-md-8">
        <div class="panel panel-primary" data-collapsed="0">
            ...
            <div class="panel-body">
                <?php echo form_open(site_url('teacher/update_online_exam_question/'.$question_id.'/update'.'/'.$question_details['online_exam_id']) , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>
...
<script type="text/javascript">
    ...
    function showOptions(number_of_options){
        $.ajax({
            type: "POST",
            url: "<?php echo site_url('teacher/manage_multiple_choices_options'); ?>",
