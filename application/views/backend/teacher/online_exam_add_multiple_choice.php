<?php echo form_open(site_url('teacher/manage_online_exam_question/'.$online_exam_id.'/add/multiple_choice') , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>
